...
export { EventHandler, EventContext, EnhancedEventContext, MutableEventContext, EmitOptions, on, send, emit, clearEvents, clearEvent } from './event-system'
...
export { renderInputPrompt } from './input-prompt'

import { MutableEventContext, EnhancedEventContext, EventRegistry, on, send } from './event-system'
import { aiTemplateFunction, listTemplateFunction, researchTemplateFunction, extractTemplateFunction, dbProxy } from './ai-template-functions'
 ...
 */
export function onWithAI(event: string, callback: (data: any, context?: EnhancedEventContext) => Promise<any> | any, timeout?: number): EventRegistry {
