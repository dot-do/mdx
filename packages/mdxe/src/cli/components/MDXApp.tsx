 ...
 */
export const MDXApp: React.FC<MDXAppProps> = ({ initialFilePath, mode = 'browse', options = {} }) => {
  const { exit } = useApp()
    ...
    return (
      <Box flexDirection='column'>
        ...
        <Box marginTop={1} borderStyle='single' borderColor='gray' padding={1}>
          <Text dimColor>
            Press <Text color='yellow'>b</Text> to go back or <Text color='yellow'>q</Text> to quit
          </Text>
        </Box>
      </Box>
    )
    ...
    <Box flexDirection='column'>
      ...
      {currentRouteNode ? (
        <>
          ...
          <Box marginTop={1} borderStyle='single' borderColor='gray' padding={1}>
            <Text dimColor>
              Press <Text color='yellow'>←</Text> to go back, <Text color='yellow'>↑/↓</Text> to navigate, <Text color='yellow'>Enter</Text> to select,{' '}
