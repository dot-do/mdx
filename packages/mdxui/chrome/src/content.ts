import { isSupportedFile, getFileExtension, detectFileTypeFromUrl } from './fileDetection.js'
import { createMonacoEditor, getLanguageFromExtension, setupBrowserEnvironment, initializeMonaco, setupMonacoThemes } from './monacoRenderer.js'
