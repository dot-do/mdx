...
/**
 * Checks if the Chrome extension is enabled
 */
...
/**
 * Sets up a Chrome extension message listener with error handling
 */
export function setupMessageListener(
  ...
  chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    try {
      console.log('Chrome Extension: Received message:', request)
...
/**
 * Creates a custom event with Chrome extension specific details
 */
