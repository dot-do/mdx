...
import { renderMdxCli } from './render.js'
import { bundleMdx } from '../bundler.js'
import { z } from 'zod'
...
program.name('ink-mdx').description('Render and bundle MDX files for CLI applications').version('0.1.0')
