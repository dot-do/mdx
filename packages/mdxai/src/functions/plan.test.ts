...
import { parseTaskLists, TaskList, TaskItem, serializeTaskItem, serializeTaskList, serializeTaskLists, serializePlanResult } from './plan'
...
describe('serializeTaskLists', () => {
  it('should serialize multiple task lists with proper spacing', () => {
    const taskLists: TaskList[] = [
      {
        heading: 'Setup',
        tasks: [{ text: 'Install dependencies', checked: true }],
      },
      {
        heading: 'Development',
        tasks: [{ text: 'Write code', checked: false }],
      },
    ]
    ...
    const taskLists: TaskList[] = [
      {
        ...
        tasks: [{ text: 'Only task', checked: false }],
      },
    ]
...
`
  ...
  it('should handle edge cases in round-trip operations', () => {
    const taskLists: TaskList[] = [
      {
        // No heading
        tasks: [{ text: 'Orphan task', checked: true }],
      },
      {
                ...
                subtasks: [
                  {
                    text: 'Level 2',
                    checked: false,
                    subtasks: [{ text: 'Level 3', checked: true }],
                  },
                ],
              },
            ],
