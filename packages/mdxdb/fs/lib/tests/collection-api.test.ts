...
describe('Collection API', () => {
  ...
  it(
    'should create a blog post using collection API',
    async () => {
  ...
  it(
    'should get a blog post by slug using collection API',
    async () => {
  ...
  it(
    'should get a blog post by title using collection API',
    async () => {
...
${content}`,
  ...
  it(
    'should update a blog post using collection API',
    async () => {
  ...
  it(
    'should delete a blog post using collection API',
    async () => {
  ...
  it(
    'should get a blog post by exact title as requested by user',
    async () => {
      const title = 'My First Blog Post'
