...
description: Denotes the sale of objects to end consumers
collection: Verbs
source: gs1
type: BusinessStep
...
cbvType: bizStep
url: 'https://ref.gs1.org/cbv/BizStep-RetailSelling'
aiEnriched: false
...
standards:
  ...
  - name: EPCIS 2.0
    ...
    version: '2.0'
createdAt: '2025-10-04T18:27:45.163Z'
updatedAt: '2025-10-04T18:27:45.163Z'
---
# Retail Selling
...
Denotes the sale of objects to end consumers
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/BizStep-RetailSelling)
