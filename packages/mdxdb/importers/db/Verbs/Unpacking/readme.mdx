...
name: Unpacking
title: Unpacking
description: Denotes the unpacking of objects from containers
collection: Verbs
source: gs1
type: BusinessStep
...
cbvType: bizStep
url: 'https://ref.gs1.org/cbv/BizStep-Unpacking'
aiEnriched: false
...
standards:
  ...
  - name: EPCIS 2.0
    ...
    version: '2.0'
createdAt: '2025-10-04T18:27:45.175Z'
updatedAt: '2025-10-04T18:27:45.175Z'
---
# Unpacking
...
Denotes the unpacking of objects from containers
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/BizStep-Unpacking)
