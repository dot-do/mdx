...
name: Installing
title: Installing
description: Denotes the installation of objects at a location
collection: Verbs
source: gs1
type: BusinessStep
...
cbvType: bizStep
url: 'https://ref.gs1.org/cbv/BizStep-Installing'
aiEnriched: false
...
standards:
  ...
  - name: EPCIS 2.0
    ...
    version: '2.0'
createdAt: '2025-10-04T18:27:45.152Z'
updatedAt: '2025-10-04T18:27:45.152Z'
---
# Installing
...
Denotes the installation of objects at a location
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/BizStep-Installing)
