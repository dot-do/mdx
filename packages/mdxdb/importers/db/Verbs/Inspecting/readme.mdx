...
name: Inspecting
title: Inspecting
description: Denotes the inspection of objects for quality or compliance
collection: Verbs
source: gs1
type: BusinessStep
...
cbvType: bizStep
url: 'https://ref.gs1.org/cbv/BizStep-Inspecting'
aiEnriched: false
...
standards:
  ...
  - name: EPCIS 2.0
    ...
    version: '2.0'
createdAt: '2025-10-04T18:27:45.147Z'
updatedAt: '2025-10-04T18:27:45.147Z'
---
# Inspecting
...
Denotes the inspection of objects for quality or compliance
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/BizStep-Inspecting)
