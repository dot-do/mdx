...
name: Collecting
title: Collecting
description: Denotes the assembly of objects for the purpose of transportation
collection: Verbs
source: gs1
type: BusinessStep
...
cbvType: bizStep
url: 'https://ref.gs1.org/cbv/BizStep-Collecting'
aiEnriched: true
...
standards:
  ...
  - name: EPCIS 2.0
    ...
    version: '2.0'
createdAt: '2025-10-04T18:27:45.118Z'
...
Denotes the assembly of objects for the purpose of transportation
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/BizStep-Collecting)
