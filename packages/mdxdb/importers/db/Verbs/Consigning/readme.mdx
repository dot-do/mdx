...
name: Consigning
title: Consigning
description: Denotes the transfer of physical possession of objects for transportation
collection: Verbs
source: gs1
type: BusinessStep
...
cbvType: bizStep
url: 'https://ref.gs1.org/cbv/BizStep-Consigning'
aiEnriched: false
...
standards:
  ...
  - name: EPCIS 2.0
    ...
    version: '2.0'
createdAt: '2025-10-04T18:27:45.120Z'
updatedAt: '2025-10-04T18:27:45.120Z'
---
# Consigning
...
Denotes the transfer of physical possession of objects for transportation
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/BizStep-Consigning)
