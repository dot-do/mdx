...
name: Repairing
title: Repairing
description: Denotes the repair of damaged objects
collection: Verbs
source: gs1
type: BusinessStep
...
cbvType: bizStep
url: 'https://ref.gs1.org/cbv/BizStep-Repairing'
aiEnriched: false
...
Denotes the repair of damaged objects
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/BizStep-Repairing)
