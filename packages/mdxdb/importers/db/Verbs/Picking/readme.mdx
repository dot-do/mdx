...
name: Picking
title: Picking
description: Denotes the selection of objects from inventory for fulfillment
collection: Verbs
source: gs1
type: BusinessStep
...
cbvType: bizStep
url: 'https://ref.gs1.org/cbv/BizStep-Picking'
aiEnriched: false
...
Denotes the selection of objects from inventory for fulfillment
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/BizStep-Picking)
