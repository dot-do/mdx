---
id: Creating_Class_Instance
name: Creating Class Instance
title: Creating Class Instance
description: Denotes the creation of a specific class of trade item
collection: Verbs
source: gs1
type: BusinessStep
...
cbvType: bizStep
url: 'https://ref.gs1.org/cbv/BizStep-CreatingClassInstance'
aiEnriched: false
...
standards:
  ...
  - name: EPCIS 2.0
    ...
    version: '2.0'
createdAt: '2025-10-04T18:27:45.121Z'
updatedAt: '2025-10-04T18:27:45.121Z'
---
...
Denotes the creation of a specific class of trade item
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/BizStep-CreatingClassInstance)
