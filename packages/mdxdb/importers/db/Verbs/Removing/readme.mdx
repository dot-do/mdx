...
name: Removing
title: Removing
description: Denotes the removal of objects from aggregations
collection: Verbs
source: gs1
type: BusinessStep
...
cbvType: bizStep
url: 'https://ref.gs1.org/cbv/BizStep-Removing'
aiEnriched: false
...
standards:
  ...
  - name: EPCIS 2.0
    ...
    version: '2.0'
createdAt: '2025-10-04T18:27:45.159Z'
updatedAt: '2025-10-04T18:27:45.159Z'
---
# Removing
...
Denotes the removal of objects from aggregations
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/BizStep-Removing)
