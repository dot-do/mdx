...
name: Assembling
title: Assembling
description: Denotes the assembly of objects into aggregations or transformations
collection: Verbs
source: gs1
type: BusinessStep
...
cbvType: bizStep
url: 'https://ref.gs1.org/cbv/BizStep-Assembling'
aiEnriched: true
...
standards:
  ...
  - name: EPCIS 2.0
    ...
    version: '2.0'
createdAt: '2025-10-04T18:27:45.116Z'
updatedAt: '2025-10-04T19:08:59.822Z'
complexity: simple
lastEnriched: '2025-10-04T19:08:59.822Z'
---
# Assembling
...
Denotes the assembly of objects into aggregations or transformations
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/BizStep-Assembling)
