...
description: Denotes a physical count of inventory
collection: Verbs
source: gs1
type: BusinessStep
...
cbvType: bizStep
url: 'https://ref.gs1.org/cbv/BizStep-CycleCounting'
aiEnriched: false
...
standards:
  ...
  - name: EPCIS 2.0
    ...
    version: '2.0'
createdAt: '2025-10-04T18:27:45.123Z'
updatedAt: '2025-10-04T18:27:45.123Z'
---
# Cycle Counting
...
Denotes a physical count of inventory
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/BizStep-CycleCounting)
