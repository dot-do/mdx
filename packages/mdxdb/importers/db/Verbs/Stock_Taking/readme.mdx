...
name: Stock Taking
title: Stock Taking
description: Denotes a comprehensive inventory count
collection: Verbs
source: gs1
type: BusinessStep
...
cbvType: bizStep
url: 'https://ref.gs1.org/cbv/BizStep-StockTaking'
aiEnriched: false
...
Denotes a comprehensive inventory count
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/BizStep-StockTaking)
