...
name: Returned
title: Returned
description: Objects have been returned
...
cbvType: disposition
url: 'https://ref.gs1.org/cbv/Disp-Returned'
aiEnriched: false
...
standards:
  ...
  - name: EPCIS 2.0
    ...
    version: '2.0'
createdAt: '2025-10-04T18:27:45.249Z'
updatedAt: '2025-10-04T18:27:45.249Z'
---
# Returned
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/Disp-Returned)
