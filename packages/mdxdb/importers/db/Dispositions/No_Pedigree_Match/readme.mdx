---
id: No_Pedigree_Match
name: No Pedigree Match
title: No Pedigree Match
description: Pedigree does not match expectations
...
cbvType: disposition
url: 'https://ref.gs1.org/cbv/Disp-NoPedigreeMatch'
aiEnriched: false
...
standards:
  ...
  - name: EPCIS 2.0
    ...
    version: '2.0'
createdAt: '2025-10-04T18:27:45.235Z'
updatedAt: '2025-10-04T18:27:45.235Z'
---
# No Pedigree Match
...
Pedigree does not match expectations
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/Disp-NoPedigreeMatch)
