---
id: Completeness_Inferred
name: Completeness Inferred
title: Completeness Inferred
description: Completeness is inferred from partial observations
...
cbvType: disposition
url: 'https://ref.gs1.org/cbv/Disp-CompletenessInferred'
aiEnriched: false
...
standards:
  ...
  - name: EPCIS 2.0
    ...
    version: '2.0'
createdAt: '2025-10-04T18:27:45.188Z'
updatedAt: '2025-10-04T18:27:45.188Z'
---
...
Completeness is inferred from partial observations
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/Disp-CompletenessInferred)
