---
id: Non_Sellable_Other
name: Non Sellable Other
title: Non Sellable Other
description: Objects are not sellable for other reasons
...
cbvType: disposition
url: 'https://ref.gs1.org/cbv/Disp-NonSellableOther'
aiEnriched: false
...
standards:
  ...
  - name: EPCIS 2.0
    ...
    version: '2.0'
createdAt: '2025-10-04T18:27:45.237Z'
updatedAt: '2025-10-04T18:27:45.237Z'
---
# Non Sellable Other
...
Objects are not sellable for other reasons
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/Disp-NonSellableOther)
