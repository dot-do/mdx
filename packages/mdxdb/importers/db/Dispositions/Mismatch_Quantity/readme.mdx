...
description: Quantity does not match expectations
...
cbvType: disposition
url: 'https://ref.gs1.org/cbv/Disp-MismatchQuantity'
aiEnriched: false
...
Quantity does not match expectations
...
- [Official GS1 Definition](https://ref.gs1.org/cbv/Disp-MismatchQuantity)
