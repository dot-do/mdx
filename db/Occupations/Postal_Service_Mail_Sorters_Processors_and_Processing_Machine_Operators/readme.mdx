...
description: >-
  Prepare incoming and outgoing mail for distribution for the United States
  Postal Service (USPS). Examine, sort, and route mail. Load, operate, and
  occasionally adjust and repair mail processing, sorting, and canceling
...
- [O*NET Online](https://www.onetonline.org/link/summary/43-5053.00)
