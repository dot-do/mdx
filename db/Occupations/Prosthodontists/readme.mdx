...
description: >-
  Diagnose, treat, rehabilitate, design, and fit prostheses that maintain oral
  function, health, and appearance for patients with clinical conditions
  associated with teeth, oral and maxillofacial tissues, or the jaw.
...
- [O*NET Online](https://www.onetonline.org/link/summary/29-1024.00)
