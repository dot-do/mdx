...
description: >-
  Compile and record employee time and payroll data. May compute employees' time
  worked, production, and commission. May compute and post wages and deductions,
  or prepare paychecks.
...
- [O*NET Online](https://www.onetonline.org/link/summary/43-3051.00)
