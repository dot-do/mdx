...
description: >-
  Design, model, or implement corporate data warehousing activities. Program and
  configure warehouses of database information and provide support to warehouse
  users.
...
- [O*NET Online](https://www.onetonline.org/link/summary/15-1243.01)
