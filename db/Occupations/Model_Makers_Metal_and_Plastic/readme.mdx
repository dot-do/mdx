...
description: >-
  Set up and operate machines, such as lathes, milling and engraving machines,
  and jig borers to make working models of metal or plastic objects. Includes
  template makers.
...
- [O*NET Online](https://www.onetonline.org/link/summary/51-4061.00)
