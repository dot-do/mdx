...
description: >-
  Teach courses in architecture and architectural design, such as architectural
  environmental design, interior architecture/design, and landscape
  architecture. Includes both teachers primarily engaged in teaching and those
...
- [O*NET Online](https://www.onetonline.org/link/summary/25-1031.00)
