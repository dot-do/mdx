...
description: >-
  Perform work involved in developing and processing photographic images from
  film or digital media. May perform precision tasks such as editing
...
- [O*NET Online](https://www.onetonline.org/link/summary/51-9151.00)
