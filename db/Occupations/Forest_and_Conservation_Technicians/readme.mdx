...
description: >-
  Provide technical assistance regarding the conservation of soil, water,
  forests, or related natural resources. May compile data pertaining to size,
  content, condition, and other characteristics of forest tracts under the
...
- [O*NET Online](https://www.onetonline.org/link/summary/19-4071.00)
