...
description: >-
  Operate computer-controlled tools, machines, or robots to machine or process
  parts, tools, or other work pieces made of metal, plastic, wood, stone, or
  other materials. May also set up and maintain equipment.
...
- [O*NET Online](https://www.onetonline.org/link/summary/51-9161.00)
