...
description: >-
  Design and develop manufactured products, such as cars, home appliances, and
  children's toys. Combine artistic talent with research on product use,
...
- [O*NET Online](https://www.onetonline.org/link/summary/27-1021.00)
