...
description: >-
  ...
  sort, and route incoming mail; and address, seal, stamp, fold, stuff, and
  affix postage to outgoing mail or packages. Duties may also include keeping
...
- [O*NET Online](https://www.onetonline.org/link/summary/43-9051.00)
