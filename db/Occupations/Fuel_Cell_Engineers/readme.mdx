...
description: >-
  Design, evaluate, modify, or construct fuel cell components or systems for
  transportation, stationary, or portable applications.
...
- [O*NET Online](https://www.onetonline.org/link/summary/17-2141.01)
