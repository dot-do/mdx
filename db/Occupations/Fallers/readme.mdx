...
title: Fallers
description: >-
  Use axes or chainsaws to fell trees using knowledge of tree characteristics
  and cutting techniques to control direction of fall and minimize tree damage.
...
- [O*NET Online](https://www.onetonline.org/link/summary/45-4021.00)
