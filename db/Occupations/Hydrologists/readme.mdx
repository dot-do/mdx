...
title: Hydrologists
description: >-
  Research the distribution, circulation, and physical properties of underground
  and surface waters; and study the form and intensity of precipitation and its
  rate of infiltration into the soil, movement through the earth, and return to
...
- [O*NET Online](https://www.onetonline.org/link/summary/19-2043.00)
