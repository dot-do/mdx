...
title: Travel Agents
description: >-
  Plan and sell transportation and accommodations for customers. Determine
  destination, modes of transportation, travel dates, costs, and accommodations
  required. May also describe, plan, and arrange itineraries and sell tour
...
- [O*NET Online](https://www.onetonline.org/link/summary/41-3041.00)
