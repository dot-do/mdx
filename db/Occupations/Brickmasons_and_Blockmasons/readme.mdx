...
description: >-
  Lay and bind building materials, such as brick, structural tile, concrete
  block, cinder block, glass block, and terra-cotta block, with mortar and other
...
- [O*NET Online](https://www.onetonline.org/link/summary/47-2021.00)
