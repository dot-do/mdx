...
description: >-
  Review settled claims to determine that payments and settlements are made in
  accordance with company practices and procedures. Confer with legal counsel on
  claims requiring litigation. May also settle insurance claims.
...
- [O*NET Online](https://www.onetonline.org/link/summary/13-1031.00)
