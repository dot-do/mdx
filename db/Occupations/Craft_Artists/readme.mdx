...
title: Craft Artists
description: >-
  Create or reproduce handmade objects for sale and exhibition using a variety
  of techniques, such as welding, weaving, pottery, and needlecraft.
...
- [O*NET Online](https://www.onetonline.org/link/summary/27-1012.00)
