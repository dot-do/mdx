...
description: >-
  Test the safety of structures, vehicles, or vessels using x-ray, ultrasound,
  fiber optic or related equipment.
...
- [O*NET Online](https://www.onetonline.org/link/summary/17-3029.01)
