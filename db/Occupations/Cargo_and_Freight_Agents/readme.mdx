...
description: >-
  ...
  shipments in airline, train, and trucking terminals and shipping docks. Take
  orders from customers and arrange pickup of freight and cargo for delivery to
  loading platform. Prepare and examine bills of lading to determine shipping
  charges and tariffs.
...
- [O*NET Online](https://www.onetonline.org/link/summary/43-5011.00)
