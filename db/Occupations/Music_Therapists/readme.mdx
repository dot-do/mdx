...
description: >-
  Plan, organize, direct, or assess clinical and evidenced-based music therapy
  interventions to positively influence individuals' physical, psychological,
...
- [O*NET Online](https://www.onetonline.org/link/summary/29-1129.02)
