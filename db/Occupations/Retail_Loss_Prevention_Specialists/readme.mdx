...
description: >-
  Implement procedures and systems to prevent merchandise loss. Conduct audits
  and investigations of employee activity. May assist in developing policies,
...
- [O*NET Online](https://www.onetonline.org/link/summary/33-9099.02)
