...
description: >-
  Position and secure steel bars or mesh in concrete forms in order to reinforce
  concrete. Use a variety of fasteners, rod-bending machines, blowtorches, and
  hand tools. Includes rod busters.
...
- [O*NET Online](https://www.onetonline.org/link/summary/47-2171.00)
