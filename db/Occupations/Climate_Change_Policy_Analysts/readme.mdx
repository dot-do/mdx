...
description: >-
  Research and analyze policy developments related to climate change. Make
  climate-related recommendations for actions such as legislation, awareness
  campaigns, or fundraising approaches.
...
- [O*NET Online](https://www.onetonline.org/link/summary/19-2041.01)
