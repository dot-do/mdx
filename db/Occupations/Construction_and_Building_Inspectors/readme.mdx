...
description: >-
  Inspect structures using engineering skills to determine structural soundness
  ...
  such as electrical systems or plumbing.
...
- [O*NET Online](https://www.onetonline.org/link/summary/47-4011.00)
