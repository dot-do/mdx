...
title: Taxi Drivers
description: >-
  Drive a motor vehicle to transport passengers on an unplanned basis and charge
  a fare, usually based on a meter.
...
- [O*NET Online](https://www.onetonline.org/link/summary/53-3054.00)
