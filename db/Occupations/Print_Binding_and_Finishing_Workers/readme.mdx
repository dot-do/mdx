...
description: >-
  Bind books and other publications or finish printed products by hand or
  machine. May set up binding and finishing machines.
...
- [O*NET Online](https://www.onetonline.org/link/summary/51-5113.00)
