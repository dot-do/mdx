...
description: >-
  Design and implement radio frequency identification device (RFID) systems used
  to track shipments or goods.
...
- [O*NET Online](https://www.onetonline.org/link/summary/17-2072.01)
