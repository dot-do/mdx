    ...
    <section className="py-32">
      <div className="container flex flex-col gap-16 lg:px-16">
        <div className="lg:max-w-2xl">
          <h2 className="mb-3 font-semibold md:mb-4 text-4xl lg:mb-6">
            {heading}
          </h2>
          <p className="text-md text-muted-foreground mb-8">{description}</p>
          <a
            href={linkUrl}
            className="group flex items-center text-base font-medium lg:text-lg"
          >
            {linkText}
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:gap-6">
          {features[0] && (
            <div className="border-border flex flex-col overflow-clip rounded-lg border md:col-span-2 md:grid md:grid-cols-2 md:gap-6 lg:gap-8">
              <div className="md:min-h-[20rem] lg:min-h-[24rem]">
                <img
          ...
          {features.slice(1).map((feature) => (
            <div
              key={feature.id}
              className="border-border flex flex-col overflow-clip rounded-lg border"
            >
              <div>
                <img
                  src={feature.image}
