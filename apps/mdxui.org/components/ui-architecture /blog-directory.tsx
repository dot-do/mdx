  ...
  return (
    <div className='w-full p-0 sm:p-2'>
      ...
      <div className='max-w-7xl mx-auto space-y-4'>
        ...
        {/* Page Hero */}
        <div className='w-full border border-gray-300 dark:border-border text-muted-foreground text-center p-4 rounded-md flex items-center justify-center bg-slate-100/50 dark:bg-slate-800/30'>Blog Hero</div>
        ...
        <div className='w-full border border-gray-300 dark:border-border text-muted-foreground text-center p-4 rounded-md flex items-center justify-center bg-slate-100/50 dark:bg-slate-800/30'>
          <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4'>
            <div className='border border-gray-300 dark:border-border text-muted-foreground text-center p-8 rounded-md bg-white/80 dark:bg-slate-700/20'>Blog Card</div>
            <div className='border border-gray-300 dark:border-border text-muted-foreground text-center p-8 rounded-md bg-white/80 dark:bg-slate-700/20'>Blog Card</div>
            <div className='border border-gray-300 dark:border-border text-muted-foreground text-center p-8 rounded-md bg-white/80 dark:bg-slate-700/20'>Blog Card</div>
            <div className='border border-gray-300 dark:border-border text-muted-foreground text-center p-8 rounded-md bg-white/80 dark:bg-slate-700/20'>Blog Card</div>
            <div className='border border-gray-300 dark:border-border text-muted-foreground text-center p-8 rounded-md bg-white/80 dark:bg-slate-700/20'>Blog Card</div>
        ...
        {/* <div className="w-full flex justify-center space-x-4">
          <div className="border border-gray-300 dark:border-border text-muted-foreground text-center px-4 py-2 rounded-md hover:bg-accent transition-colors cursor-pointer bg-slate-100/50 dark:bg-slate-800/30">Prev</div>
          <div className="border border-gray-300 dark:border-border text-muted-foreground text-center px-4 py-2 rounded-md hover:bg-accent transition-colors cursor-pointer bg-slate-100/50 dark:bg-slate-800/30">Next</div>
        </div> */}
