export const softwareCategories = {
  ...
  'Asset management Software': ['Mileage Tracking Software'],
  'Audio Software': ['Audio Editing Software', 'Audio Engine Software', 'Business Music Software'],
  'Aviation Software': [
  ...
  'Biotech Software': ['LIMS Software', 'Other Laboratory Software', 'Other Life Sciences Software'],
  ...
  'Customer Sevices Software': ['Proactive Notification Software'],
  ...
  'Gaming Software': ['Game Engine Software', 'Gamification Software', 'Gaming Tools'],
  ...
  'Government Software': ['Public Transportation Software', 'Public Works Software', 'US State & Local Government Software'],
  'HR Services': [
  ...
  'Hardware Management Software': ['CMMS Software', 'IoT Device Management Software', 'IoT Operating Systems', 'Other IoT Software'],
  'Healthcare Services': ['Ancillary Care Providers', 'Health & Safety Providers', 'Healthcare Service Providers', 'Other Medical Services Providers'],
  'Healthcare Software': [
  ...
  'Homecare Software': ['Child Care Software', 'Cleaning Services Software', 'Other Child Care Software', 'Pet Sitting and Daycare Software'],
  'IBM Reseller': ['IBM Security VARs', 'IBM Server VARs', 'IBM Storage VARs'],
  'IT Consulting': [
  ...
  Legal: ['Regulatory Change Management Software'],
  'Legal Services': ['Corporate Law Firms', 'Intellectual Property (IP) Law Firms', 'Other Legal Services Providers'],
  'Legal Software': [
  ...
  'Logisitics Software': ['Harbor Operations Software'],
  'Logistics Services': ['Freight Forwarding Services Providers', 'Third-Party Logistics Providers'],
  'Logistics Software': [
    '3PL Software',
  ...
  'Operations Software': ['Business Process Management Software', 'Mobile Forms Automation Software', 'Print Fulfillment Software'],
  'Oracle Consulting': [
  ...
  'Property Management Software': ['Community Association Management Software', 'Concierge Software'],
  'Property management Software': ['Multiple Listing Service (MLS) Listing Software', 'Parking Management Software'],
  ...
  'Sales & Marketing Software': ['B2B Services Review Platforms', 'Product Reviews Software'],
  'Sales Services': [
  ...
  'Security Hardware': ['Advanced Threat Protection (ATP) Hardware', 'Firewall Hardware', 'Industrial Security Hardware'],
  'Security Services': [
  ...
  Server: ['Blade Servers', 'Industrial Switching', 'Rack Servers', 'Tower Servers'],
  Storage: ['All-Flash Arrays (AFA) Hardware', 'Cloud Storage Hardware', 'Network Attached Storage (NAS) Hardware', 'Storage Servers', 'Tape Storage Hardware'],
  'Training Services': [
  ...
  'Translation Software': ['Computer-Assisted Translation Software'],
  'Transportation Software': ['Other Transportation Software', 'Ride Sharing Software', 'Taxi & Limousine Software', 'Transportation Management Software'],
  'Travel Software': ['Other Travel Arrangement Software'],
  'VR / AR': [
  ...
  'Workflow Automation': ['iPaaS Software', 'Productivity Bots Software'],
